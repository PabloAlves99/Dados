...
class ManipulaRepositorios:
    ...
    def __init__(self, username):
        ...
        self.access_token = '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'
...
novo_repo = ManipulaRepositorios('PabloAlves99')
...
novo_repo.add_arquivo(NOME_REPO, 'linguagens_amzn.csv',
                      'dados/linguagens_amzn.csv')
novo_repo.add_arquivo(NOME_REPO, 'linguagens_netflix.csv',
                      'dados/linguagens_netflix.csv')
novo_repo.add_arquivo(NOME_REPO, 'linguagens_spotify.csv',
                      'dados/linguagens_spotify.csv')
